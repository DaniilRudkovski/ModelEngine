...
implements Connection {
    ...
    implements Connection.Response {
        ...
        static Response execute(Request req, @Nullable Response previousResponse) throws IOException {
            ...
            try {
                ...
                if (conn.getContentLength() != 0 && req.method() != Connection.Method.HEAD) {
                    ...
                    res.bodyStream = ControllableInputStream.wrap(stream, 32768, req.maxBodySize()).timeout(startTime, req.timeout());
                } else {
        ...
        public Document parse() throws IOException {
            ...
            InputStream stream = this.bodyStream;
        ...
        private static @Nullable String setOutputContentType(Connection.Request req) {
