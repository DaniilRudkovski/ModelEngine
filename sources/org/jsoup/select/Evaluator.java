...
public abstract class Evaluator {
    ...
    extends CssNthEvaluator {
        public IsNthLastOfType(int a, int b2) {
            super(a, b2);
        }
    ...
    extends CssNthEvaluator {
        public IsNthOfType(int a, int b2) {
            super(a, b2);
        }
    ...
    extends CssNthEvaluator {
        public IsNthLastChild(int a, int b2) {
            super(a, b2);
        }
    ...
    extends CssNthEvaluator {
        public IsNthChild(int a, int b2) {
            super(a, b2);
        }
    ...
    extends Evaluator {
        ...
        public CssNthEvaluator(int a, int b2) {
            this.a = a;
            this.b = b2;
        }
