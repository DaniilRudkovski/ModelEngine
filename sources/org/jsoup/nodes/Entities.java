...
public class Entities {
    ...
    private static  @Nullable Document.OutputSettings DefaultOutput;
        ...
        for (int offset = 0; offset < length; offset += Character.charCount(codePoint)) {
            ...
            if (codePoint < 65536) {
                ...
                switch (c2) {
                    ...
                    default: {
                        if (c2 < ' ' || !Entities.canEncode(coreCharset, c2, encoder)) {
            ...
            String c3 = new String(Character.toChars(codePoint));
