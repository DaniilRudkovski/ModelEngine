 ...
 */
package com.ticxo.modelengine.v1_21_R7.parser.behavior;
...
implements BehaviorRendererParser<HeldItemRenderer> {
    ...
    private ClientboundSetEntityDataPacket itemData(HeldItemRenderer.Item renderer, boolean spawn) {
        ...
        renderer.getRotation().ifDirty(quaternionf -> entityData.add(new SynchedEntityData.DataValue(13, EntityDataSerializers.QUATERNION, (Object)quaternionf.rotateY((float)Math.PI, new Quaternionf()))), spawn);
    ...
    private ClientboundEntityPositionSyncPacket teleport(HeldItemRenderer renderer) {
        ...
        return new ClientboundEntityPositionSyncPacket(container.getId(), PositionMoveRotation.of((Entity)container), container.onGround());
    }
