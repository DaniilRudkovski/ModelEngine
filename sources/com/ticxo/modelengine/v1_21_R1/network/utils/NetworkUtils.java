...
public class NetworkUtils {
    ...
    public static final ProtocolInfo<ServerGamePacketListener> SERVERBOUND_CODEC = GameProtocols.SERVERBOUND_TEMPLATE.bind(RegistryFriendlyByteBuf.decorator((RegistryAccess)MinecraftServer.getServer().registryAccess()));
