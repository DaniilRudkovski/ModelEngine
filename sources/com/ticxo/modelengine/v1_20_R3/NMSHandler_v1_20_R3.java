...
import com.ticxo.modelengine.v1_20_R3.entity.EntityHandlerImpl;
...
import com.ticxo.modelengine.v1_20_R3.parser.behavior.LeashParser;
import com.ticxo.modelengine.v1_20_R3.parser.behavior.MountParser;
import com.ticxo.modelengine.v1_20_R3.parser.behavior.NameTagParser;
import com.ticxo.modelengine.v1_20_R3.parser.behavior.SegmentParser;
import com.ticxo.modelengine.v1_20_R3.parser.behavior.SubHitboxParser;
import com.ticxo.modelengine.v1_20_R3.parser.model.DisplayParser;
import com.ticxo.modelengine.v1_20_R3.parser.vfx.VFXDisplayParser;
import com.ticxo.modelengine.v1_20_R3.ui.AnvilHandlerImpl;
...
public class NMSHandler_v1_20_R3
implements NMSHandler {
    ...
    private final AnvilHandler anvilHandler = new AnvilHandlerImpl();
    ...
    public void sendPivotOverrides() {
        ...
        for (PivotOverride override : dirty) {
            PacketDataSerializer byteBuf = NetworkUtils.createByteBuf(buf -> {
                buf.c(override.getId());
                Collection list = (Collection)override.getPassengers().get();
                buf.c(list.size());
                list.forEach(arg_0 -> ((PacketDataSerializer)buf).c(arg_0));
            });
