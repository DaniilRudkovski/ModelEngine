...
implements BehaviorRendererParser<SubHitboxRenderer> {
    ...
    private PacketPlayOutSpawnEntity hitboxSpawn(SubHitboxRenderer.SubHitbox renderer) {
        ...
        return new PacketPlayOutSpawnEntity(renderer.getHitboxId(), renderer.getHitboxUuid(), (double)pos.x, (double)pos.y, (double)pos.z, 0.0f, 0.0f, EntityTypes.ac, 0, Vec3D.b, 0.0);
    }
