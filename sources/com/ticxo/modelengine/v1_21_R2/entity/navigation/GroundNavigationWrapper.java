 ...
 */
package com.ticxo.modelengine.v1_21_R2.entity.navigation;
...
public class GroundNavigationWrapper
extends GroundPathNavigation {
    public GroundNavigationWrapper(Mob mob, GroundPathNavigation oldNav) {
        super(mob, mob.level());
        this.setCanFloat(oldNav.canFloat());
        this.setCanOpenDoors(oldNav.canOpenDoors());
        this.setCanPassDoors(oldNav.canPassDoors());
    }

    public boolean moveTo(@Nullable Path newPath, double speed) {
        if (!ModelEngineAPI.getAPI().getConfigManager().getBoolean(ConfigProperty.OVERRIDE_MOVE_TO)) {
