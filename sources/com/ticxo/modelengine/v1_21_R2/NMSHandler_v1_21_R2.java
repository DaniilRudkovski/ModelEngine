 ...
 *  org.joml.Vector3fc
 */
package com.ticxo.modelengine.v1_21_R2;
...
import com.ticxo.modelengine.v1_21_R2.entity.EntityHandlerImpl;
import com.ticxo.modelengine.v1_21_R2.network.NetworkHandlerImpl;
...
import com.ticxo.modelengine.v1_21_R2.parser.behavior.LeashParser;
import com.ticxo.modelengine.v1_21_R2.parser.behavior.MountParser;
import com.ticxo.modelengine.v1_21_R2.parser.behavior.NameTagParser;
import com.ticxo.modelengine.v1_21_R2.parser.behavior.SegmentParser;
import com.ticxo.modelengine.v1_21_R2.parser.behavior.SubHitboxParser;
import com.ticxo.modelengine.v1_21_R2.parser.model.DisplayParser;
import com.ticxo.modelengine.v1_21_R2.parser.vfx.VFXDisplayParser;
...
public class NMSHandler_v1_21_R2
implements NMSHandler {
    ...
    public void sendPivotOverrides() {
        ...
        for (PivotOverride override : dirty) {
            FriendlyByteBuf byteBuf = NetworkUtils.createByteBuf(buf -> {
                buf.writeVarInt(override.getId());
                Collection list = (Collection)override.getPassengers().get();
                buf.writeVarInt(list.size());
                list.forEach(arg_0 -> ((FriendlyByteBuf)buf).writeVarInt(arg_0));
            });
