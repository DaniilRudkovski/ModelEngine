...
public enum NMSFields implements ReflectionUtils.ReflectionEnum
{
    ...
    LIVING_ENTITY_noJumpDelay(LivingEntity.class, "cf", "noJumpDelay"),
    LIVING_ENTITY_jumping(LivingEntity.class, "bn", "jumping"),
    MOB_lookControl(Mob.class, "bP", "lookControl"),
    MOB_moveControl(Mob.class, "bQ", "moveControl"),
    MOB_navigation(Mob.class, "bS", "navigation"),
    MOB_goalSelector(Mob.class, "bT", "goalSelector"),
    MOB_bodyRotationControl(Mob.class, "cb", "bodyRotationControl"),
