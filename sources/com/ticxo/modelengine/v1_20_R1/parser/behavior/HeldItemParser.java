...
implements BehaviorRendererParser<HeldItemRenderer> {
    ...
    private PacketPlayOutEntityMetadata itemData(HeldItemRenderer.Item renderer, boolean spawn) {
        ...
        renderer.getGlowColor().ifDirty(color -> EntityUtils.writeData(buf, 21, DataWatcherRegistry.b, color), spawn);
        ...
        renderer.getRotation().ifDirty(quaternionf -> EntityUtils.writeData(buf, 12, DataWatcherRegistry.B, quaternionf), spawn);
