...
public enum NMSFields implements ReflectionUtils.ReflectionEnum
{
    ...
    LIVING_ENTITY_noJumpDelay(EntityLiving.class, "cb", "noJumpDelay"),
    LIVING_ENTITY_jumping(EntityLiving.class, "bk", "jumping"),
    ...
    MOB_bodyRotationControl(EntityInsentient.class, "bT", "bodyRotationControl"),
