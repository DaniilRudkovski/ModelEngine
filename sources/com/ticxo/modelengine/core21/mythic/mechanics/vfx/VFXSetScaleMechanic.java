...
@MythicMechanic(name="vfxscale", aliases={"vfxscl", "vfxsca"})
public class VFXSetScaleMechanic
...
INoTargetSkill {
    ...
    public VFXSetScaleMechanic(MythicLineConfig mlc) {
        String coords = mlc.getString(new String[]{"s", "sca", "scl", "scale"}, null, new String[0]);
        if (coords != null) {
    ...
    public SkillResult castAtEntity(SkillMetadata meta, AbstractEntity target) {
        ...
        if (this.relative) {
            vfx.getScale().add((float)this.x.get((PlaceholderMeta)meta, target), (float)this.y.get((PlaceholderMeta)meta, target), (float)this.z.get((PlaceholderMeta)meta, target));
        } else {
            vfx.setScale(new Vector3f((float)this.x.get((PlaceholderMeta)meta, target), (float)this.y.get((PlaceholderMeta)meta, target), (float)this.z.get((PlaceholderMeta)meta, target)));
        }
    ...
    public SkillResult cast(SkillMetadata meta) {
        ...
        if (this.relative) {
            vfx.getScale().add((float)this.x.get((PlaceholderMeta)meta), (float)this.y.get((PlaceholderMeta)meta), (float)this.z.get((PlaceholderMeta)meta));
        } else {
            vfx.setScale(new Vector3f((float)this.x.get((PlaceholderMeta)meta), (float)this.y.get((PlaceholderMeta)meta), (float)this.z.get((PlaceholderMeta)meta)));
        }
        return SkillResult.SUCCESS;
    }
}
