...
public enum NMSFields implements ReflectionUtils.ReflectionEnum
{
    ...
    LIVING_ENTITY_noJumpDelay(LivingEntity.class, "bQ", "noJumpDelay"),
    LIVING_ENTITY_jumping(LivingEntity.class, "bf", "jumping"),
    MOB_lookControl(Mob.class, "bB", "lookControl"),
    MOB_moveControl(Mob.class, "bC", "moveControl"),
    MOB_navigation(Mob.class, "bE", "navigation"),
    MOB_goalSelector(Mob.class, "bF", "goalSelector"),
    MOB_bodyRotationControl(Mob.class, "bN", "bodyRotationControl"),
