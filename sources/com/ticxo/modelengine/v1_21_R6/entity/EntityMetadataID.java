...
public class EntityMetadataID {
    ...
    public static final int DISPLAY_POS_ROT_DURATION = 10;
    ...
    public static final int DISPLAY_BRIGHTNESS = 16;
    ...
    public static final int DISPLAY_GLOW_COLOR = 22;
    public static final int ITEM_DISPLAY_ITEM = 23;
    public static final int ITEM_DISPLAY_TYPE = 24;
    public static final int TEXT_DISPLAY_TEXT = 23;
    public static final int TEXT_DISPLAY_BACKGROUND = 25;
    public static final int TEXT_DISPLAY_OPACITY = 26;
    public static final int TEXT_DISPLAY_OPTIONS = 27;
    public static final int AREA_EFFECT_CLOUD_RADIUS = 8;
    public static final int LIVING_ENTITY_HAND_DATA = 8;
    public static final int LIVING_ENTITY_HEALTH = 9;
