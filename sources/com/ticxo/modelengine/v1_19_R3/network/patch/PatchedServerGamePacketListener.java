...
public class PatchedServerGamePacketListener {
    ...
    public static void handleInteract(final ServerboundInteractPacketWrapper interactPacket, PacketListenerPlayIn listener) {
        ...
        interactPacket.a(new PacketPlayInUseEntity.c(){
            ...
            private void performInteraction(EnumHand enumhand, EntityInteraction entityInteraction, PlayerInteractEntityEvent event) {
                ...
                if (itemstack.a(serverLevel.G())) {
                    ...
                    if (triggerLeashUpdate && (event.isCancelled() || player.fJ().f().c() != origItem)) {
                        connection.a((Packet)new PacketPlayOutAttachEntity(entity, ((EntityInsentient)entity).fJ()));
                    }
            ...
            public void a() {
                ItemStack itemstack;
                if (!(entity instanceof EntityItem || entity instanceof EntityExperienceOrb || entity instanceof EntityArrow || entity == player && !player.F_() || !(itemstack = player.b(EnumHand.a)).a(serverLevel.G()))) {
                    player.d(entity);
    ...
    public static void handleUseItem(PacketPlayInBlockPlace packet, PacketListenerPlayIn listener, Consumer<EnumInteractionResult> afterUse) {
        ...
        if (!itemstack.b() && itemstack.a(worldserver.G())) {
            ...
            float f7 = f4 * f5;
            float f8 = f3 * f5;
            double d3 = player.d.b() == EnumGamemode.b ? 5.0 : 4.5;
            Vec3D vec3d1 = vec3d.b((double)f7 * d3, (double)f6 * d3, (double)f8 * d3);
            MovingObjectPositionBlock movingobjectposition = player.H.a(new RayTrace(vec3d, vec3d1, RayTrace.BlockCollisionOption.b, RayTrace.FluidCollisionOption.a, (net.minecraft.world.entity.Entity)player));
            if (movingobjectposition == null || movingobjectposition.c() != MovingObjectPosition.EnumMovingObjectType.b) {
                ...
                cancelled = player.d.firedInteract && player.d.interactPosition.equals((Object)movingobjectpositionblock.a()) && player.d.interactHand == enumhand && ItemStack.a((ItemStack)player.d.interactItemStack, (ItemStack)itemstack) ? player.d.interactResult : (event = CraftEventFactory.callPlayerInteractEvent((EntityHuman)player, (Action)Action.RIGHT_CLICK_BLOCK, (BlockPosition)movingobjectpositionblock.a(), (EnumDirection)movingobjectpositionblock.b(), (ItemStack)itemstack, (boolean)true, (EnumHand)enumhand)).useItemInHand() == Event.Result.DENY;
            ...
            EnumInteractionResult enuminteractionresult = player.d.a(player, (World)worldserver, itemstack, enumhand);
    ...
    private static void callPlayerUseUnknownEntityEvent(CraftServer cserver, CraftPlayer craftPlayer, PacketPlayInUseEntity packet, EnumHand hand) {
        cserver.getPluginManager().callEvent((Event)new PlayerUseUnknownEntityEvent((Player)craftPlayer, packet.getEntityId(), packet.getActionType() == PacketPlayInUseEntity.b.b, hand == EnumHand.a ? EquipmentSlot.HAND : EquipmentSlot.OFF_HAND));
    }
